...
class Carousel extends Component {
  ...
  renderIndicatorItem = (items) => {
    ...
    return (
      <ul className={classnames('rain-indicator__wrapper', {
  ...
  render() {
    ...
    const {items} = this.state
    return (
      <div className={classnames('rain-carousel', {
        'rain-carousel__card': this.iscard
      }, className)}
      ...
      >
        ...
        <div className="rain-carousel__container"
